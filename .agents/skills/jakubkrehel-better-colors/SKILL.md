...
| --- | --- | --- |
| L (Lightness) | 0?? | 0 = black, 1 = white. Perceptually uniform. |
| C (Chroma) | 0?0.4 | Colorfulness. 0 = gray. Max depends on L and H. |
| H (Hue) | 0??60 | Hue angle in degrees. |
| alpha | 0?? | Optional transparency. Slash syntax. |
...
| Hue drift threshold | > 10簞 spread across palette steps = visible drift |
