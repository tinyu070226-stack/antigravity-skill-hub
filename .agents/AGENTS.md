...
- **核心架構與路由規則 (永久生效)**：
  ...
  4. **`presentation-skill`**：整合 10 大客製化簡報視覺風格 Specs (含霓虹拼貼, Apple Mockup, Kinfolk 雜誌風, 瑞士商業風等)、Slidev 導出器以及 `beautiful-article` 10 大文章保留率類型與 11 大大師排版主題 (Tufte, Bodoni, Vignelli)。
